...
def get_model(model_name: str, model_provider: ModelProvider) -> ChatOpenAI | ChatGroq | ChatOllama | None:
    if model_provider == ModelProvider.GROQ:
        ...
        if not api_key:
            # Print error to console - Fixed: Generic message to avoid information disclosure
            print(f"Authentication Error: Required API credentials are not configured.")
            raise ValueError("Required API credentials are missing. Please check your environment configuration.")
